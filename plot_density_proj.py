...
# USE_IDX if particle IDs are not unique (e.g., with STARFORGE jets).
def plot_density_proj_disk_USE_IDX(s, disk_name, disk_idx, verbose=False, **kwargs):

    disk_x = s.p0_x[disk_idx]
